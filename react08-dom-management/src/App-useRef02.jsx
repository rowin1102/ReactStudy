...
function App() {
  ...
  /* 스테이트를 변경시키면 그때마다 화면이 새롭게 렌더링된다. 이것은 App() 함수를 재호출하는 것이므로,
    지역변수로 선언된 countVar는 그때마다 0으로 초기화된다. 즉, 컴포넌트의 생명주기 안에서 값을
    유지하고 싶다면 State나 Ref를 사용해야 되고, 그렇지 않다면 일반적인 변수를 사용하면 된다. */
  return (<>
